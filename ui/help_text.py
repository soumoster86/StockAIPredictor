...
HELP = {
    ...
    "journal": "Backtests look backward; the journal looks forward. Each logged signal is later scored against what the market actually did — the most honest performance measure this app produces. Each login has its own journal file.",
    ...
    "scanner": "Screener: ranks the watchlist with a Buy Score (probability, OOS edge, risk, reward:risk, near support) and lists best long candidates. Uses the global model when available. Screen only — open a stock for the full Signal before acting. Not investment advice.",
