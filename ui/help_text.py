...
HELP = {
    ...
    "scanner": "Screener: load precomputed rankings (offline job) for instant results, or walk the full watchlist live in batches of 80. Rankings use Buy Score. Screen only — open a stock for the full Signal. Not investment advice.",
